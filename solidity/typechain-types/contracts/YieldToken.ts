...
export interface YieldTokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "InsufficientMint",
...
export interface YieldToken extends BaseContract {
  ...
  InsufficientMint: TypedContractMethod<
  ...
  mintForStudent: TypedContractMethod<
    [to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "InsufficientMint"
  ): TypedContractMethod<
    [to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "mintForStudent"
  ): TypedContractMethod<
    [to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
